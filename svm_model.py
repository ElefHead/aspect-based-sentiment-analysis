...
def vectorized_svm(x_train, y_train, x_test, y_test, x_elec, y_elec, x_food, y_food, checktrain=True, ngram_range=(1, 1), vector_type="count"):
...
def main():
    ...
    vectorized_svm(x_train, y_train, x_test, y_test, x_elec, y_elec, x_food, y_food, ngram_range=(1,1), vector_type="count")
    vectorized_svm(x_train, y_train, x_test, y_test, x_elec, y_elec, x_food, y_food, ngram_range=(1,1), vector_type="tfidf")
